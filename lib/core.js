...
class NewmanConfig{
    ...
    static allure_report_path() {
        return path.relative(NewmanConfig.current_path(), files.getCurrentDirectoryBase() + 'reports/allure')
    }

    static newman_json_report_path() {
        return path.relative(NewmanConfig.current_path(), files.getCurrentDirectoryBase() + 'reports/json/')
    }

    static newman_html_report_path() {
        return path.relative(NewmanConfig.current_path(), files.getCurrentDirectoryBase() + 'reports/html/')
    }
